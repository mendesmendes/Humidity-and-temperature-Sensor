...
//***********Things to change*******************
const char* ssid = "WI-FI_2G";
const char* password = "21436587";
String GOOGLE_SCRIPT_ID = "AKfycbwe5eaRU2ZXHimx9t3k8wT9gC-zcG1qRh-OJ3JDYVMHr1G-aTNUmMst_eL-s3QetMWayA"; // Replace by your GAS service id
